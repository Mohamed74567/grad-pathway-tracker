...
You are required to submit your [online application](https://ndsugrad.my.site.com/Application/TX_SiteLogin?startURL=/Application/TargetX_Portal__PB) and nonrefundable $35 application fee. The fee must be paid before the application will be processed or reviewed.

Application fees are waived for McNair Scholars, U.S. Armed Forces and Veterans, and Native American applicants. Contact [ndsu.grad.school@ndsu.edu](mailto:ndsu.grad.school@ndsu.edu) to request an application fee waiver.

If you're a returning applicant, you can log in to your account [here](https://ndsugrad.my.site.com/Application/TX_SiteLogin?startURL=/Application/TargetX_Portal__PB&_gl=1*1t2oqhz*_ga*Nzc5MDM2NzI0LjE3NDg2MjQ1NzQ.*_ga_VJPGNTJ40B*czE3NTMxMTk2MDkkbzgkZzEkdDE3NTMxMTk4NDAkajYwJGwwJGgxNTk3NDg3NzUz).

### Statement of Purpose

A statement of purpose is required for admission consideration and must be uploaded to your [online application](https://ndsugrad.my.site.com/Application/TX_SiteLogin?startURL=/Application/TargetX_Portal__PB&_gl=1*1t2oqhz*_ga*Nzc5MDM2NzI0LjE3NDg2MjQ1NzQ.*_ga_VJPGNTJ40B*czE3NTMxMTk2MDkkbzgkZzEkdDE3NTMxMTk4NDAkajYwJGwwJGgxNTk3NDg3NzUz).
...
A resume or Curriculum Vita (CV) is required for admission consideration and must be uploaded to your [online application](https://ndsugrad.my.site.com/Application/TX_SiteLogin?startURL=/Application/TargetX_Portal__PB&_gl=1*1t2oqhz*_ga*Nzc5MDM2NzI0LjE3NDg2MjQ1NzQ.*_ga_VJPGNTJ40B*czE3NTMxMTk2MDkkbzgkZzEkdDE3NTMxMTk4NDAkajYwJGwwJGgxNTk3NDg3NzUz).
...
Here are the requirements for submitting official transcripts:
  ...
  * In order to be considered for admission, your bachelor's degree must have been received from a college or university accredited by a recognized [regional accrediting association](https://www.chea.org/regional-accrediting-organizations). If you attended a non-U.S. college or university, your degree must have been received from a recognized institution with degree requirements that are similar to those at North Dakota State University.
...
*If you have attended any institution(s) outside of the United States, you must follow the process to submit an [international transcript](https://www.ndsu.edu/graduate-school/apply#international-1). 
...
[GRE (Graduate Record Examination)](https://www.ets.org/gre) – Official GRE test scores should be sent electronically to NDSU (institution code 6474). A specific department code is not required.

[GMAT (Graduate Management Admission Test)](https://www.mba.com/us) – Please arrange to have official test scores sent directly to the Graduate School.
...
Minimum score requirements:
  ...
  * [TOEFL](https://www.ets.org/toefl): 71 (internet-based) or 525 (paper-based)
  * [IELTS](https://www.ielts.org/): 6.0 (academic version)
  * [Duolingo](https://englishtest.duolingo.com/): 105 (internet-based)
  * [PTE Academic](https://www.pearsonpte.com/)score of 50



Some programs require a higher minimum score. Refer to the [program's catalog page](https://catalog.ndsu.edu/graduate/) for more information.
...
The official score must be received by the Graduate School before an application will be considered.
  ...
  * Official IELTS test scores must be sent from the testing center by mail or electronically to North Dakota State University. Please note that the academic version is required. The general training version will not be accepted for admission.
  * Official Duolingo scores must be sent electronically to North Dakota State University - Graduate.



The language test date must be within two years of the date of application to the Graduate School.

Your specific graduate program may require different minimum scores. See the minimum required scores for your program of interest by selecting your program in the [Graduate Catalog](https://catalog.ndsu.edu/graduate/). 
...
To be eligible for a Graduate Teaching Assistantship (GTA), applicants must meet higher English language test score minimums. View GTA score minimums for TOEFL, IELTS and Duolingo [here](https://catalog.ndsu.edu/graduate/graduate-school-policies/english-language-proficiency-procedure/).
...
Official transcripts (statement of marks) may be sent in either of two ways:
  ...
  * Transcript Evaluation: the Graduate School prefers that your educational credentials be evaluated by [WES](https://www.wes.org/evaluations-and-fees/education/north-dakota-state-university-graduate-school-credential-evaluation-requirements/)(World Education Services),[ECE](https://accounts.ece.org/TPO/NDSU-F)(Educational Credential Evaluators),[IEE](https://myiee.org/university/north-dakota-state-university---graduate)(International Education Evaluations),[TEC](https://app.evalcompany.com/4720bf4b-51f5-4c3c-a5a5-ed860f869255)(The Evaluation Company), or another[NACES](https://naces.org/members/)(National Association of Credential Evaluation Services) member. Please Note: The evaluation must be on a course-by-course basis.
...
This requirement may be met by applicants who have:
  ...
  * Been raised in a recognized country where English is the only official language
  * Earned a bachelor's degree or higher from a recognized institution in a recognized country where English is the only official language (Some programs may require a language score even if an applicant meets this requirement)
  * Achieved a satisfactory TOEFL (Test of English as a Foreign Language), IELTS (International English Language Testing System), Duolingo score (see details below) or PTE (Academic) – Pearson Test of English (Academic)
...
[GRE (Graduate Record Examination)](http://www.ets.org/gre/) – Official GRE test scores should be sent electronically to NDSU (institution code 6474). A specific department code is not required.

[GMAT (Graduate Management Admission Test)](https://www.mba.com/) – Please arrange to have official test scores sent directly to the Graduate School.
...
Application to a graduate certificate program requires submission of the following materials. All the materials are submitted to the Graduate School.
  ...
  * A completed [NDSU Graduate School application](https://ndsugrad.my.site.com/Application/TX_SiteLogin?startURL=/Application/TargetX_Portal__PB).
  ...
  * A statement of purpose — required by a limited number of certificate programs.
...
This category is for individuals who desire to pursue study beyond the baccalaureate degree for personal growth and improvement of skills but not in order to work toward an advanced degree objective. Individuals who hold a baccalaureate degree from an institution of recognized standing, as well as current undergraduate students at North Dakota State University, may enroll as non-degree graduate students.
...
Non-degree graduate applicants must submit the following:
  ...
  * [Online Application](https://ndsugrad.my.site.com/Application/TX_SiteLogin?startURL=/Application/TargetX_Portal__PB)– Create an application account or log in to submit your application
...
Programs being offered in this accelerated format are listed in the online [University Catalog](https://catalog.ndsu.edu/academic-policies/degree-and-graduation/#accelerateddegreeprogramsugrdtogradtext).

### General Requirements

Undergraduate students must have completed a minimum of 60 undergraduate credits prior to the first semester in which graduate courses are taken. Their cumulative GPA must be 3.00 or higher. Some accelerated programs do require a higher cumulative GPA for participation. Students should meet with their undergraduate advisor or the department chairperson/head in their major to learn whether an accelerated program is a good fit. If so,

  * Students will complete the [Combined/Accelerated Degree Program Declaration Form](https://powerforms.docusign.net/b40bdfd4-58b2-46bb-8fb3-3a890efd93de?env=na3&acct=1ceb9a57-b6a3-4df7-b655-d64cf8f1c2d7)
  ...
  * If declaration is approved, the student will make formal application to the [NDSU Graduate School](https://ndsugrad.my.site.com/Application/TX_SiteLogin?startURL=/Application/TargetX_Portal__PB)for the intended master’s degree program.
...
### What to know before Applying to the Master's Degree Program
  ...
  * Accelerated students are admitted to the graduate program in [conditional standing](https://catalog.ndsu.edu/graduate/admission-information/#admissionstatustext). To move to full standing, students must:
...
If you choose to apply to more than one graduate program, submit a new statement of purpose and a $35 application fee. If you would like to use any previously submitted documents, please email us at [ndsu.grad.school@ndsu.edu](mailto:ndsu.grad.school@ndsu.edu).
