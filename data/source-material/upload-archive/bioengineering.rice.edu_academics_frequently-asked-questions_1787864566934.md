### GRE Requirements Update

Please note: the Rice University Department of Bioengineering will no longer require applicants to submit Graduate Record Examination (GRE) scores for doctoral or masters program admission, effective immediately.

### The Admission Process

  * When should candidates begin the PhD application process?
  * Research from the last several years has shown that the GRE can act as a barrier to entry for many students applying to graduate schools. Effective immediately, the Rice University Department of Bioengineering has decided to remove the GRE as a requirement for all doctoral program applications. Our department is committed to recruiting the best students from all backgrounds. Our admission committee holistically reviews all prospective students’ applications.

If the TOEFL is required per an applicant's unique circumstances (see A Complete Application), we encourage applicants to take the test before September for the year in which you are applying. Applicants should request transcripts before September as well to give senders time to get the material to Rice University by the application deadline. Application materials received after the deadline will not be considered.

Applicants cannot request letters of recommendation before September 1 when the application cycle begins because requests must be sent via our graduate application program, SLATE.

  * How do I apply to the PhD program?
  * Applicants must use the online application at gradapply.rice.edu. Paper applications are no longer accepted.

  * How do I apply to the MBE program?
  * Applicants must use the online application at gradapply.rice.edu. Paper applications are no longer accepted. The online application system requires candidates to select either the Applied Bioengineering concentration or the Global Medical Innovation (GMI) concentration. The GRE is not required for all MBE program applicants. If you wish to apply to both MBE concentrations, you must submit a separate application for each concentration.

If an applicant is applying for two degree programs in the Department of Bioengineering, please contact us (bioegradprogram@rice.edu or 713.348.5063) for specific instructions regarding the application fee.

Students currently in the undergraduate program in bioengineering at Rice must contact the academic program administrator (bioegradprogram@rice.edu or 713.348.5063) for specific instructions regarding the submission of your application.

  * Is it necessary to submit transcripts from all colleges/universities attended?
  * Yes, although if admitted to the program you will also need to send electronically a final transcript with the degree awarded in the event that you accept the admissions offer. Transcripts from all schools attended should be uploaded to gradapply.rice.edu when completing their application. If accepted students must send a transcript. It must be sent directly from the school and in the format the school typically uses (paper or electronic). We will not accept transcripts directly from the students.

  * What supplemental material should be submitted?
  * If it is applicable to their situation (see A Complete Application) or to the program, applicants must electronically submit TOEFL, IELTS, or Duolingo scores. All applicants must submit a minimum of three recommendation letters, transcripts from colleges/universities attended and the application fee. You may also submit papers you have written, a resume, awards received, etc.

The Rice University Department of Bioengineering will no longer require applicants to submit Graduate Record Examination (GRE) scores for doctoral or masters program admission, effective immediately.

  * May I apply for the spring semester to the PhD program?
  * No, we admit all PhD students during the fall semesters of each academic year.

  * Can I apply to the PhD program with a bachelor’s degree or must I have a master’s degree to apply?
  * Yes, you can apply to the PhD program with a bachelor's degree.

  * Is the PhD deadline also applicable to the MBE programs?
  * No, the application deadlines for the Applied Bioengineering MBE program and Global Medical Innovation (GMI) MBE program are different.

  * Are applicants required to go through an interview?
  * Yes, we do interview applicants applying to the PhD program.

  * Is there a way to check our application status for acceptance or rejection?
  * Unfortunately, at this time there is not this capability. Official letters are mailed to the mailing address indicated on the on-line application during mid- to late-March.

  * Can candidates get an application fee waiver?
  * The application fee is waived for PhD students.

  * What is the cost of tuition and fees?
  * While these costs are generally not posted until late spring, you may periodically check this the Rice University Cashier's Office website for past and future information.

  * Is there a minimum GPA requirement?
  * The minimum GPA for admission to both the PhD and the MBE in Global Medical Innovation is 3.2

  
The minimum GPA for admission to the MBE in Applied Bioengineering is 3.0
  * Do I have to take the GRE?
  * Research from the last several years has shown that the GRE can act as a barrier to entry for many students applying to graduate schools. Effective immediately, the Rice University Department of Bioengineering has decided to remove the GRE as a requirement for all doctoral or masters program applications. Our department is committed to recruiting the best students from all backgrounds. Our admission committee holistically reviews all prospective students’ applications.

  * Is there a GRE score requirement?
  * The Rice University Department of Bioengineering will no longer require applicants to submit Graduate Record Examination (GRE) scores for doctoral or masters program admission, effective immediately.

  * Do applicants need to take the Test of English as a Foreign Language (TOEFL)?
  * The Test of English as a Foreign Language (TOEFL) is required for students who have not received a degree from a university in the United States or where English is the official language of instruction. The TOEFL is administered through the Educational Testing Service, Box 6151, Princeton, New Jersey 08541-6151 USA [telephone (609) 771-7100]. You can also send an e-mail to toefl@ets.org or contact a center in your native country. The ETS Reporting code for Rice University is 6609. Arrangements must be made with the Educational Testing Service (ETS) to have official, TOEFL scores sent to Rice University. The ETS reporting code for Rice University is 6609.

Students whose native language is not English may also use the International English Language Testing System (IELTS).

Applicants whose native language is not English must take the TOEFL test and should score at least 4.5 on the iBL (internet-based) TOEFL. For students who choose to take the IELTS in lieu of TOEFL, the minimum score is 7. The minimum score for the Duolingo test is 115.

The TOEFL, IELTS, or Duolingo may be waived for an international student who received a degree from a university in the United States where English is the official language of instruction.

  * What are the appropriate codes for submitting TOEFL scores?
  * The institution code for Rice University is 6609.

  * May I submit my TOEFL score late?
  * No. Scores must be available when graduate admission decisions are made. Register to take the TOEFL as required a minimum of 90 days prior to the PhD or MBE application deadlines.

  * Is the recruiting weekend mandatory?
  * No, however, one-on-one in-person interviews with core faculty are held during this time--these interviews provide invaluable insight for our graduate programs. Additionally, this is an opportunity for prospective students to visit the campus and city, learn about our core faculty's research, and enjoy the company of our current graduate students. Recruiting weekend is typically held in the month of March immediately proceeding application submission.

  * Do you provide financial aid and how do I apply?
  * All students seeking a PhD receive a full tuition waiver, health insurance subsidy, and a stipend--all dependent upon satisfactory progress in the program. To learn more, see Training Grants and Fellowships.

The Rice University Office of Financial Aid does not offer scholarships to graduate students in the Department of Bioengineering, but loan options and payment plans are available for consideration. Visit their website for resources and additional information.
...
The minimum GPA for admission to the MBE in Applied Bioengineering concentration is 3.0
  ...
  * Applicants to both the Global Medical Innovation (GMI) MBE Major concentration Applied Bioengineering (AB) MBE Major concentration will participate in virtual or in-person interviews.

Interviews give applicants the ability to share their goals for graduate school and beyond, and learn more about each of the Master's programs that the BIOE department offers.
...
### MBE in Global Medical Innovation (GMI)
  ...
  * When you are ready, attach the following documents to your application at gradapply.rice.edu. The GRE is not required for all MBE program applicants.
...
If you are an international student, TOEFL, IELTS, or Duolingo scores that are less than three years old are required.

  * What is the timeline once I’ve submitted my application?
  * Application deadline for the Global Medical Innovation program is December 31. MD/MBE applications are due January 31.
...
The GRE is not required for all MBE program applicants.
...
The Rice University Department of Bioengineering will no longer require applicants to submit Graduate Record Examination (GRE) scores for doctoral program admission, effective immediately. The GRE is not required for all MBE program applicants.
  ...
  * In certain circumstances, the Test of English as a Foreign Language (TOEFL) is required for students who have not received a degree from a university in the United States or where English is not the official language of instruction. 
    ...
    * The internet-based TOEFL iBL is offered more than 50 times a year and is administered online at testing sites around the world. Applicants whose native language is not English must take the TOEFL test and should score at least 90 on the TOEFL iBL.
    * Students whose native language is not English may also use the International English Language Testing System (IELTS) Academic test. For students who choose to take the IELTS in lieu of TOEFL, the minimum score is 7. For the Duolingo test, a minimum score of 115 is required.
    * Make arrangements to have all official scores sent to Rice University. The codes for submitting TOEFL scores is 6609 for Rice University.
...
*The application fee has been waived for all PhD program applicants.