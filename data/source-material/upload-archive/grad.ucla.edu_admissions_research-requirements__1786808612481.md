...
UCLA Graduate Admissions: Application Process, Requirements & Resources

Connect with us and learn about our services on the  [Graduate Education Portal](https://ucla.service-now.com/graduateeducationportal). 
...
Be sure to consult your specific [UCLA graduate program](https://grad.ucla.edu/) for the specific deadline for your proposed major. Applications to some programs may be considered if received after a program’s stated deadline, provided that the enrollment limitations have not been exceeded. Fellowships and other financial support depend on availability of funds.
...
The UCLA [application for graduate admission](https://grad.ucla.edu/admissions/admission-application-for-graduate-admission/) should be used to apply for all programs with the exception of the M.D. in [Medicine](https://medschool.ucla.edu/education/md-education), the J.D., S.J.D, and L.L.M. in [Law](https://www.law.ucla.edu/), the D.D.S. in [Dentistry](https://dentistry.ucla.edu/academics-admissions), and M.B.A. and M.F.E. programs in the Anderson Graduate School of [Management](https://www.anderson.ucla.edu/), which have separate admission application processes.

University regulations do not permit an applicant to apply to more than one major, with the exception of already-established [concurrent or articulated degrees](https://grad.ucla.edu/admissions/concurrent-articulated-programs/).
...
Your adjusted gross income (or that of your family) as given on your U.S. Federal Income Tax return must be less than the figure in the table below, based on the size of your family (including yourself).
  ...
  * Submit a copy of your 2025 U.S. Federal Income Tax return. Provide either your own form 1040, if you are independent, or a copy of your parent’s or guardian’s 2025 Federal Income Tax return, if listed as a dependent.
...
Event-based waivers may waive the 2026-2027 application fee for PhD and state-supported doctoral programs. Please note that this program is subject to change or termination. Inquire about event-based fee waivers at [designated conferences and recruitment events](https://grad.ucla.edu/admissions/diversity-inclusion-and-admissions-dia-recruitment-calendar/). Note: Only attendees at in-person events are eligible to receive this fee waiver.

As an applicant, you must follow UCLA’s Student Code of Conduct. The Code applies to applicants who become students for offenses committed during the application process. Submitting work that is not your own, including material written by AI, may be considered academic dishonesty and could affect your admission.

[Read the Student Code of Conduct](https://studentconduct.ucla.edu/individual-student-code).
  ...
  * Having AI write all or part of your essay
  * Submitting generic or fabricated content
  * Misrepresenting your experiences, goals, or research



Admissions committees want to hear your voice: your academic goals, personal experiences, and unique perspective. These are what make your essay compelling. Academic dishonesty includes cheating, fabrication or falsification, plagiarism, multiple submissions, or facilitating academic misconduct.

Your application must be truthful and reflect your own work. Essays that rely heavily, or entirely, on AI may be treated as academic dishonesty. Providing false, incomplete, or misleading information in your application, interviews, documents, or communications may result in removal from consideration and withdrawal of any recommendation or offer of admission or funding.

Your story, in your own words, is the most powerful part of your application. We look forward to learning more about you.
...
The Personal Statement is an opportunity for you to provide additional information that may aid the selection committee in evaluating your preparation and aptitude for graduate study at UCLA. The personal statement will also be used to consider candidates for the [Eugene Cota-Robles Award](https://grad.ucla.edu/funding/financial-aid/funding-for-entering-students/eugene-v-cota-robles-fellowship/) and the [Graduate Opportunity Program](https://grad.ucla.edu/funding/financial-aid/funding-for-entering-students/graduate-opportunity-fellowship-program-gofp/).

Instructions to respond to one or more of the following prompts are provided in the application and include a 500 words limit (approximately 1-page, single spaced, using 1-inch margins and 12-point font):
  ...
  * Describe ways in which your perspectives, experiences, or aspirations have aligned with UCLA’s [Principles of Community](https://www.ucla.edu/about/mission-and-values).
...
Applicants, including U.S. citizens and Permanent Residents, who do not hold a bachelor’s degree or higher from an accredited university located in the United States or in another country where English is the sole language of instruction according to the [World Higher Education Database](https://whed.net/home.php) (WHED), please consult [English Requirements](https://grad.ucla.edu/admissions/english-requirements/).
...
Submitted application materials are reviewed by faculty admissions committees in each major program who select the best qualified applicants. These admissions committees base recommendations for admission upon a careful comparison of applications, and this may take considerable time. Recruitment, Outreach and Admissions, therefore, cannot guarantee that the applicant will receive a response, favorable or unfavorable, on or before any specific date. The applicant, moreover, should not construe a lack of response as an intention to act favorably on the application.
...
If you wish to read more about the [Council of Graduate Schools resolution re: April 15th](https://cgsnet.org/resources/for-current-prospective-graduate-students/april-15-resolution/).
...
Admission offers are typically valid only for the initial term to which a student is admitted.

Graduate programs may, at their discretion, recommend deferral of admission for applicants who have been admitted but are unable to enroll in the academic term for which admission was granted. Deferral requests are subject to review and must be approved by the admitting department. Programs are not required to approve deferral requests.

If approved, a deferral may be granted for no more than one academic year or for a subsequent academic quarter within the same academic year. All deferral requests must be submitted prior to the first day of instruction of the originally admitted term. Requests submitted on or after the first day of instruction may be denied or require additional review and approval.

Deferral of admission does not guarantee continuation or deferral of any graduate employment or financial support. Admitted students should contact their program to determine whether deferral is available and to comply with all applicable procedures and deadlines.

Exception:

  * Active military service: Admitted students with active military orders may request a deferral for the duration of their service. Admitted students in this category should consult their program regarding the deferment process.



If a deferral is not possible:  


Admitted students who do not enroll in their initial admission term are eligible to reapply using the Renewal application:

  * Renewal is available only if you were admitted within the past year.
  * Select “Renewal” under Application Type in the graduate application.
  * You must submit the application and any updated materials, but no application fee is required for one renewal.
  * If more than a year has passed since your admission, you must submit a new application, including the application fee and all required documents.
  * Renewal applications are not guaranteed admission.
...
View a list of [concurrent and articulated degree programs](https://grad.ucla.edu/admissions/concurrent-articulated-programs/) at UCLA.

  * [UCLA Fees and Living Expenses](https://grad.ucla.edu/admissions/graduate-student-fees-tuition-living-expenses/)  
Sample budget for most programs, subject to change.


  * [Residence for Tuition Purposes](https://registrar.ucla.edu/fees-residence/residence-requirements)  
Information about how to establish California residence for tuition purposes.
  * [Student Health Insurance Plan (SHIP)](https://www.studenthealth.ucla.edu/insurance)  
...
There is a variety of both University and privately-owned housing available to UCLA graduate students. University housing consists of off-campus apartments for married, single parent and single graduate students.
  * [Student Parking Information](https://transportation.ucla.edu/)  
Student parking assignments are made on a need-based point system that considers such factors as class standing and commute distance, and favors those students who demonstrate the greatest need. If you wish to obtain an individual parking permit, you must submit a Student Parking Request form prior to the quarterly deadlines.
  ...
  * [Summer Session](https://summer.ucla.edu/)  
The UCLA Summer Sessions offer approximately 500 undergraduate and graduate courses each summer. Up-to-date information on course offerings, policies, and fees is available on the Summer Sessions and Special Programs website by mid-January each year.
  * [Disabled Student Services](https://cae.ucla.edu/)  
The University of California, Los Angeles actively encourages persons with disabilities to apply for admission. Federal Law (Section 504 of the Rehabilitation Act of 1973) prohibits the University from requesting disability related information prior to admission. However, at any time, applicants are welcome to contact the Center for Accessible Education to obtain information regarding access, programs and available services.
  * [Program Requirements](https://grad.ucla.edu/academics/graduate-study/program-requirements-for-ucla-graduate-degrees/)  
Official listing of degree requirements by program.
  * [General Catalog](https://catalog.registrar.ucla.edu/)  
UCLA online catalog.