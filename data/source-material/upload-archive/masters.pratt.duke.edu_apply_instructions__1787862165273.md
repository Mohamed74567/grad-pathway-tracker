...
#### Application Requirements:
  ...
  * Online application for the Pratt School of Engineering 2027
  * Transcripts and Undergraduate GPA, plus grade scales if your school does not use the 4.0 scale
  * Resume
  * Short answer questions
  * Letters of recommendation
  * Video introduction
  * Application fee
  * Courses and Technical Skills Assessment
...
GRE scores are optional for all 2027 applicants.
...
Program Undergraduate Degree Prior Coursework Prior Work Experience Artificial Intelligence
...
Work experience is not required Biomedical Engineering One of these:
...
Work experience is not required Climate & Sustainability Engineering
...
Work experience is not required Cybersecurity Undergraduate degree • Proficiency in at least one programming language (Python preferred), use of AI tools for coding and development and any cybersecurity-related tools

• One course in networking strongly recommended

• Preferred coursework in Computer Science, Calculus, Linear Algebra

Work experience is not required Design & Technology Innovation One of these:
...
• 1 semester of physics, with laboratory strongly preferred

• Prior coursework in human-centered design. Probability and statistics and linear algebra is highly encouraged but not required for admission

Work experience is not required Electrical & Computer Engineering One of these:
...
Programming or Computer Science Work experience is not required Engineering Management One of these 
...
• 2 or more courses in engineering, computer science, mathematics, or physics
...
Financial Technology – Accelerated Undergraduate degree in finance, economics, engineering, mathematics, sciences • Econometrics, statistics, linear algebra

• Programming or Computer Science

• Calculus I, II, and III or higher

Two years full-time work experience is required Financial Technology – Campus or Online Undergraduate degree in finance, economics, engineering, mathematics, sciences • Econometrics, statistics, linear algebra

• Programming or Computer Science

• Calculus I, II, and III or higher

Work experience is not required Game Design, Development & Innovation Undergraduate degrees in a variety of disciplines accepted but coursework in programming required • Classes, workshops, or tutorials that demonstrate expertise in one or more areas: Programming and scripting languages; game development tools; game design fundamentals; user interface (UI) and user experience (UX); art and animation; mathematics; sound design; narrative design
...
Work experience is not required, but may be useful AI+Materials
...
Work experience is not required Mechanical Engineering One of these
...
• Proficiency in at least one programming language (Python preferred), experience using CAD/FEA or CFD software, general machine shop skills

Work experience is not required Photonics & Optical Sciences • An undergraduate degree in a STEM or STEM-adjacent field

• Undergraduate degree

Work experience is not required Risk Engineering One of these:
...
Work experience is not required Robotics & Autonomy One of these:
...
As part of the online application, applicants must upload one (1) copy of a scanned unofficial transcript from each institution attended where you earned academic credit.
...
Duke and the Pratt School of Engineering reserve the right to rescind any offer of admission if any discrepancies are found between your uploaded unofficial transcript(s) and official transcript(s).
...
Transcript Requirements
  ...
  * Applicants who attend a Sino-foreign university, dual degree, or 2+2 program must submit transcripts from both institutions.
...
Questions vary by degree or certificate program and will update in your online application after you select the program on the Program Information page. Find your program and its short answer questions below:
  ...
  *     * Why are you applying for the MEng program in biomedical engineering at Duke University?
    ...
    * What is the longest work experience (within or outside academia) you have had and how has it informed your decision to pursue a master’s degree in BME?
  ...
  *     * What activity or experience, not in your resume/CV, sets you apart from other Cybersecurity applicants? (Note that “good grades” typically do not set candidates apart.)
    ...
    * Why are you pursuing a master’s degree in cybersecurity?
...
Consideration of the impact a design may have on people, communities, and systems; creative and critical engagement with technology; and a rigorous and future-facing vision of desirability, feasibility, viability, and sustainability.  
Please select one of these principles and explain how you hope to contribute and grow regarding that principle at Duke.
  ...
  *     * Imagine it is five years after you graduate from Duke’s Master of Engineering Management program. What is the most significant impact you have made in your career and on your organization?
  ...
  *     * FinTech is all about creating new and innovative solutions, in your opinion what is the most creative fintech solution of the past 20 years and why do you consider it the most creative?
    ...
    * If you had six months and one teammate to build a fintech product, what would you build, who would use it, and what would the first shipped version actually do? Be concrete about the user, problem, and what gets cut from version one.
  ...
  *     * Many people are excited by the idea of making games. Far fewer are prepared for the actual process of making them. Building games often involves uncertainty, iteration, failed ideas, technical setbacks, shifting priorities, difficult collaboration, and long periods where progress feels slow or unclear. In the Game Design, Development, and Innovation M.Eng. program, we embrace this process.  
Tell us about a time you remained committed to a difficult long-term creative or technical process. What made it challenging? How did you navigate uncertainty, setbacks, or changing expectations? What did you learn about how you work, collaborate, and persist through ambiguity? How do you think this experience prepares you for the highly collaborative and production-driven environment of Duke’s M.Eng. in Game Design, Development, and Innovation?
  ...
  *     * Why are you applying for the Master of Engineering in MedTech Design?
    ...
    * What is the longest work experience (within or outside academia) you have had and how has it informed your decision to pursue a master’s degree in MedTech?
  ...
  *     * What was the most complicated thing you’ve ever designed/built, either physical or virtual? Please describe it here and include a link to an online portfolio of your work or a well-labeled graphic in the field below your answer.
    ...
    * How do you feel Duke will assist you on your path to personal success and how will you contribute to the success of our community? Please give specific examples from what you have learned about our school.
    * Upload a PDF copy of a technical/research paper you have written as part of your academic/professional experience relevant to your intended area of study at Duke
  *     * What unique activity or past experience sets you apart from other applicants to the Duke Systems Engineering program (note: must be something other than “good grades”)?
    * Please tell us about your motivation for applying to the Systems Engineering graduate program — what do you hope to get out of the experience and how will it prepare you for your future career plans?
    * If you could design any complex system to address a significant problem or challenge in the world, what would the system be and why?
...
Program Number of Required Recommendations Recommendation Provider Type(s) Master’s Campus Three (3) • Academic – At least two (2) for 2026 graduates 

• Industry/professional – Not required but helpful (ex: Internship supervisor, full-time job supervisor, research advisor)

Master’s Online Three (3) Industry/professional – At least one (1) must be from work in industry (ex: supervisor) Grad Certificate Two (2) Industry/professional – At least one (1) must be from work in industry (ex: supervisor) Non-Degree Two (2) Academic – One (1) 
...
Test Code Information Duolingo English Test No institutional code. 
...
IELTS Report scores to “Duke University Pratt School of Engineering” TOEFL Institution code 5156 (Duke University); no department code
...
American Samoa India Saint Kitts and Nevis Antigua and Barbuda Ireland Saint Lucia Australia Jamaica Saint Vincent and the Grenadines Bahamas Kenya Samoa Belize Kingdom of Eswatini Seychelles Bermuda Kiribati Sierra Leone Botswana Lesotho Singapore Cameroon Malawi Tonga Canada Namibia Trinidad and Tobago Dominica Nauru Tuvalu Fiji New Zealand Uganda Gambia, The Nigeria United Kingdom Ghana Northern Mariana Islands United Republic of Tanzania Guam Papua New Guinea Virgin Islands (British & U.S.) Guyana Rwanda Zambia
...
Eligibility Required Action A current Duke or DKU student No action is needed, automatic EdAssist by Bright Horizons benefits Apply to a participating Duke engineering master’s program and indicate this in the application Submitted and paid an application fee for a Duke Graduate School Application to the Master of Science in BME, CEE, ECE, or MEMS only for the same term of admission Send proof of payment to pratt_masters@duke.edu Attended a live event hosted by Duke’s Pratt School of Engineering, in person or online An active but un-submitted Pratt School of Engineering application Participated in the Peace Corps or Teach for America, within one year of your date of application Send a letter signed by the program director verifying your participation within one year of application to pratt_masters@duke.edu An active member, reservist, or veteran of the U.S. Armed Forces No action is needed, automatic A Fulbright candidate Send a letter signed by the program director verifying your participation within one year of application to pratt_masters@duke.edu
