Transcript with Razorbot on 8/15/2026, 3:24:48 PM

Opens in a new window

Hi there! I’m a virtual assistant here to answer your questions. What would you like to know?
...
Students who have been enrolled in the Graduate School within the five preceding academic years but have not enrolled in the immediately preceding semester may be readmitted if:
  ...
  * Former students seeking to resume their graduate degree program should complete a new Application for Admission and indicate that they are a previously enrolled graduate student. A reactivation fee will apply (if required). Standard application deadlines apply.
...
Admission as a special, non-degree seeking student is not intended to serve as a means of access to regular, graduate degree-seeking status. Non-degree students who later wish to pursue a graduate degree must reapply for admission as a graduate degree-seeking student and meet the admission requirements of the Graduate School and be admitted by the academic program.
...
Note: More detailed information can be found in [Fayetteville Policies and Procedures 515.0](https://vcfa.uark.edu/fayetteville-policies-procedures/emsp/5150.php).
...
If you are an international graduate student, please visit the [International Graduate Admissions](https://international-students.uark.edu/admissions/graduate-students.php) website.

Unofficial transcripts are uploaded as part of the application process.

Upload unofficial copies* academic records/transcripts/mark sheets into your [application portal](https://applygsie.uark.edu/apply/). For evaluation purposes, you may submit an unofficial copy of each transcript needed. Review of your application will begin once your fee and all required documents for evaluation have been submitted.
...
Official transcripts are required for enrollment if you're offered admission.

IMPORTANT: The student cannot have direct contact with these documents at all.

The UA considers the following as official:

  * Emailed directly from the institution or via 3rd party service
  * Student’s prior institution(s) mails directly to the University of Arkansas. 
    * documents must be in a sealed and stamped envelope
    * if given directly to the student to bring to campus, student is not permitted to open the envelope. Unsealed documents will be considered unofficial.
  * Schools in China: Academic documents from China — including transcripts, graduation certificates, and degree certificates in Chinese and in English — must be verified by either the [China Academic Degrees and Graduate Education Development Center](https://nam11.safelinks.protection.outlook.com/?url=http%3A%2F%2Fwww.chinadegrees.cn%2F&data=05%7C02%7Cmb237%40uark.edu%7C165465effa2d474346d108dca0e5f1c4%7C79c742c4e61c4fa5be89a3cb566a80d1%7C0%7C0%7C638562156667749770%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C0%7C%7C%7C&sdata=kJXpDEo1bi9kuT6ydaaKuL0d6o%2BjN4pWLBNjt0T6yqM%3D&reserved=0)(CDGDC) or the[China Higher Education Student Information and Career Center](https://nam11.safelinks.protection.outlook.com/?url=https%3A%2F%2Fwww.chsi.com.cn%2F&data=05%7C02%7Cmb237%40uark.edu%7C165465effa2d474346d108dca0e5f1c4%7C79c742c4e61c4fa5be89a3cb566a80d1%7C0%7C0%7C638562156667761631%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C0%7C%7C%7C&sdata=kjYICvgrjW7niKoq6wb%2FIcsiWnwoDSDSPPHFEkxvGjc%3D&reserved=0)(CHESICC). Verification reports from these agencies may be mailed directly to the Graduate and International Admissions Office, or uploaded through the applicant portal. Documents other than the verification report will not be considered official.
...
Follow these steps to complete your admission to the University of Arkansas:
  ...
  * APPLY[Visit the apply now section](https://graduate-students.uark.edu/admissions/#apply-now-to-the-graduate-school)below to complete and submit the online application for admission.
  * PAY APPLICATION FEE  
...
If required by program, request official GRE score be sent directly to the University of Arkansas (institution code = 6866). Other graduate level standardized tests (such as MAT and GMAT) may be submitted in lieu of the GRE.
  * TAKE ENGLISH PROFICIENCY EXAM  
If your native language is not English:[submit verification of English proficiency](https://international-students.uark.edu/admissions/english-language-proficiency.php)


  * [Visit the apply now section](https://graduate-students.uark.edu/admissions/index.php#apply-now-to-the-graduate-school)below to start the online application for admission.  
On the General Information tab, select Yes to the following questions:

\- Have you ever applied or been a student at the University of Arkansas

\- Are you a former student seeking to resume your graduate degree program?

On the Program Information tab, select your previous program. If your program is not available as an option, please email us at gradapp@uark.edu.
...
**Application fee may be waived under certain circumstances.
  ...
  * APPLY[Visit the apply now section](https://graduate-students.uark.edu/admissions/#apply-now-to-the-graduate-school)below to complete and submit the online application for admission.
  * Complete the [Senior Citizen Tuition & Fee Waiver Form](https://admissions.uark.edu/_resources/documents/senior_citizen_feewaiver.pdf)*.  
Applicants to graduate level programs should submit this form to the Graduate School Admissions Office:  
213 Gearhart Hall,  
1 University of Arkansas,  
Fayetteville, AR 72701
  * If seeking a degree, check your programs website for additional requirements. The Graduate School requires: 
...
There is no “space available” in classes that do not meet enrollment minimums and are cancelled, or in self-supporting classes until paid enrollment is sufficient to cover costs associated with offering the class. Enrollment minimums are established by Academic Policy 1640.10. This is applicable to campus, online and off-campus classes including study abroad.
  ...
  * If your native language is not English: [verification of English proficiency](https://international-students.uark.edu/admissions/english-language-proficiency.php)
...
Visit the [reset password page](https://applygsie.uark.edu/account/reset?r=https%3a%2f%2fapplygsie.uark.edu%2fapply%2f&s=&ds=) for returning users. Do not create an account using a separate email address.

If you need help, please call [1-866-234-3957](tel:1-866-234-3957) or email [gradinfo@uark.edu](mailto:gradinfo@uark.edu).

If you are a previous graduate-level U of A student seeking to reactivate enrollment into the same graduate degree program after being out one or more semesters, please follow these instructions:

  * For all graduate programs, besides business, [apply to the Graduate School](https://graduate-and-international.uark.edu/apply.php).
    * On the General Information tab, select Yes to the following questions:
...
On the Program Information tab, select your previous program. If your program is not available as an option, please email us at gradapp@uark.edu.
  ...
  *   * If you have previously applied to graduate for this degree program and wish to continue enrollment, you will need to complete the [Reapplication to Graduate](https://registrar.uark.edu/_resources/pdf/reapplication_to_graduate.pdf)form and return it to the Registrar's Office.
  * If you are starting a new program or adding a second program, please see 'Start a New Application' section above.



For Graduate Business programs, contact Admissions at [479-575-2851](tel:1-479-575-2851).

Choose an applicant type to learn more about what to expect after you apply.

Response times will vary depending upon the volume of applications and time of year. You are welcome to contact us at [gradapp@uark.edu](mailto:gradapp@uark.edu) with any questions you may have.
...
Master's students will need to submit an original transcript, along with a [Transfer of Credit — Master's form](https://graduate-and-international.uark.edu/_resources/forms/transfer-credit-master.pdf) signed by the major advisor, to the graduate school.

Graduate Certificate students will need to submit an original transcript, along with a [Transfer of Credit form](https://graduate-and-international.uark.edu/_resources/forms/transfer-credit-master.pdf) signed by the major advisor, to the graduate school.

Doctoral students will need to submit an original transcript, along with a [Transfer of Credit — Doctoral form](https://graduate-and-international.uark.edu/_resources/forms/transfer-credit-doctoral.pdf) signed by the major advisor, to the graduate school.

We strongly encourage prospective students to visit campus. The Graduate School will plan a custom visit based on your needs. [Campus Visit Request](https://graduate-and-international.uark.edu/visit.php)
...
The University of Arkansas Graduate School does not require a standardized test score (GRE, GMAT or other graduate-level standardized test) for official admission to the university. However, individual programs may require a standardized test score. Contact your [program directly](https://graduate-students.uark.edu/academics/index.php) for more information.

The Walton Graduate School of Business has a waiver process for qualifying master’s students – please visit their admissions page for further information, [Apply for Admission: Graduate School of Business](https://walton.uark.edu/graduate-programs/apply.php)
...
The University of Arkansas awarded over $3 million in fellowships just this year alone! Some of the numerous funding opportunities available include:
  ...
  * Benjamin Franklin Lever Tuition Fellowship: Provides financial assistance to students who demonstrate significant financial need, are first-generation college students, have a history of overcoming challenges, or originate from a geographic area that is less well-represented at the University.
...
Additional information about these opportunities can be found on the [Cost and Funding](https://graduate-students.uark.edu/cost-and-funding/index.php) page.

You would need to apply for admission to your desired program, and then apply to receive transfer credit for your previous studies. Please see the above entry for the [requirements to transfer in a course](https://graduate-students.uark.edu/admissions/#transfer-requirements).

To establish state residency you will need to establish a domicile in the state of Arkansas and continue that residency for a period of six months. After six months you can appeal for a change of residency status with the Office of the Registrar. If you live in Texarkana or Bowie County, Texas you are already considered in-state. See [Resident Reclassification for Fee Purposes](https://registrar.uark.edu/student-records/resident-reclassification/index.php) for more information.

The University of Arkansas currently has on-campus housing for graduate students in the Duncan Ave. Apartments. For information visit the [University Housing website](https://housing.uark.edu/). Currently there is no on-campus housing for married students. The Fayetteville area does offer several other housing options for students many of which are on the university bus routes. More information can be found on the [ Off-Campus Housing](https://offcampushousing.uark.edu/) site.