...
We hope that you find the answers to your questions here, but if not, please reach out to our office via email to graduate@maine.edu or by calling 207.581.3291.

### What is the best way to get in touch with a potential faculty advisor?

Prospective students applying to doctoral and thesis-based master’s programs are encouraged to make email contact with faculty members with whom they would like to study. Steps to reach out to faculty are listed below. It is recommended that these steps are completed either prior to or concurrently with the admissions process, typically two to three semesters before your intended start date. Refer to the [Graduate School website](https://umaine.edu/graduate/programs/) for your chosen program’s application deadline.

1.) Review faculty listings and identify up to five individuals whose research interests you.  
2.) Email the top two to three faculty members that you would like to work with – you can see a sample email below.  
...
5.) If you need assistance connecting with faculty, email [graduate@maine.edu](mailto:graduate@maine.edu).
...
For the programs with rolling admission, the Graduate School recommends that students apply a minimum of 2 months before the first day of the semester. Please check with the [program to which you are applying](http://umaine.edu/graduate/programs), to see if they have an earlier deadline.
...
Official transcripts can be sent by the institution to graduate@maine.edu or 5775 Stodder Hall Orono, Maine 04469-5775. Official scores should be requested through the testing agency, navigate here for [the institutional codes](https://umaine.edu/graduate/apply/test-scores/).
...
Please be sure the email address you entered is correct in the online application portal. Recommenders should also check their spam or junk mail folders, often the email can be misdelivered. If neither of the above prove successful, please review the instructions in the [How to Update Reference Information](https://drive.google.com/file/d/12h_M0YOIGqqL_5biZxKP-jXWJT1kX9ir/view?usp=sharing) document and select a new email address for your recommender. If after this step you are still experiencing problems, please ask your recommender to send their recommendation on your behalf to graduate@maine.edu.

Please note that if you or your reviewer live in or are currently visiting a [sanctioned country](https://trust.salesforce.com/blocked), this will also prevent your reference request from going through.

### How do I start an application?

First, be sure that you have created an account for the [online application portal ](https://umainegradschool.my.site.com/onlineApp/TX_SiteLogin?startURL=%2FonlineApp%2FTargetX_Portal__PB)by entering your name and email address. You’ll receive an activation email (check your junk or spam folders) and be set to start your application.

If you’ve already created an account, [sign in](https://umainegradschool.my.site.com/onlineApp/TX_SiteLogin?startURL=%2FonlineApp%2FTargetX_Portal__PB) and select the ‘Start a New Application’ button.

### I can’t remember my password, how do I reset it?

If you can’t remember your password, use the [reset password](https://umainegradschool.my.site.com/onlineApp/TX_ForgotPassword) page to send a temporary password link to the email address you used to create the account.

### I didn’t receive the email to activate my account. What do I do?

Reach out to us via email to graduate@maine.edu and we can help to get your account activated. We ask that you refrain from creating another account, but if you do, let us know so that we can combine the two accounts.
...
No. To avoid delays in processing, we highly encourage all applicants to email the revision (including revised documents if applicable) to graduate@maine.edu and we will make the requested revision if appropriate.

### I accidentally withdrew my application, should I start another one?

No. Email the Coordinator of Training & Data Management (jessica.ouellette1@maine.edu) and request that your application be re-opened.
...
We encourage international students to submit financial documentation, also referred to as the [Affidavit of Support](https://umaine.edu/graduate/wp-content/uploads/sites/1016/2025/10/Declaration-of-Finances-Form-updated.pdf), at the time of admission but no later than the [deadlines posted on our website here](https://umaine.edu/graduate/apply/application-checklist/#intl). Financial documentation is only required for those who do not receive university funding. For an estimate of expenses, navigate to the Office of International Programs [website here](https://umaine.edu/international/international-admissions/expenses/).

### Once I am accepted, what do I need to do to obtain my I-20?

If the student is offered an assistantship, either the program or department will send in the necessary paperwork to the Graduate School documenting the financial details, which will release the I-20. Alternatively, if the student is self-paying or has a sponsor, they will fill out the [Affidavit of Support](https://umaine.edu/graduate/wp-content/uploads/sites/1016/2025/10/Declaration-of-Finances-Form-updated.pdf) form and [upload it through our online portal](https://app.smartsheet.com/b/form/81393f00d9804430b558b186e774d4fa) for our staff to process and issue the I-20.
...
An international application deadline of July 1 is strongly encouraged for fall applications, and November 1 for spring applications, for non-Canadian and non-SEVIS transfers. Past this timeframe, it is challenging for students to schedule a [visa appointment](https://umaine.edu/international/isss/students/immigration-visas/apply/), arrange travel, and arrive on time.
...
Please allow 1-2 weeks for credentials to be received and for the processing of your application. This time frame may be shorter if you submit a complete application and possibly longer during peak application periods (December – February). Continue to log into your [application dashboard](https://umainegradschool.my.site.com/onlineApp/TX_SiteLogin?startURL=%2FonlineApp%2FTargetX_Portal__PB) to track missing supplemental materials.
...
Waitlisted applications have been reviewed by the faculty reviewing committee and are potentially awaiting additional information or they need to determine if they have funding or capacity to take on additional students. Applicants who have been waitlisted are encouraged to [connect with the faculty](https://umaine.edu/academics/programs/?_academic_program_type=education-specialist,graduate-certificate,doctoral,master) if they have not already done so.
...
If you have already confirmed your offer of admission through the applicant dashboard, [complete this form](https://app.smartsheet.com/b/form/d1764b5a9b2f4d7f8acf6727d13cdbd3) to request an admission deferral. We will forward your request along to the admitting program for their review and will notify you of the decision. Note: admission deferrals will not be granted to international students who have not provided the necessary financial documentation.
...
Many graduate students receive funding at UMaine through an assistantship. Navigate to the individual program or department page to see if they offer funding in the form of teaching assistantship (TA) or research assistantship (RA). If the program does not offer funding, accepted students can apply to [other graduate assistantships in offices throughout campus](https://umaine.edu/graduate/funding/prospective/#openpositions). All positions are very competitive. Any job posting that references FAFSA or federal work study is a position that is only available to domestic students.

### What are the housing options at your University if I attend?

The University of Maine offers two options for on-campus housing for graduate students in [Stodder Hall](https://umaine.edu/housing/graduate-housing/) and in [University Park](https://umaine.edu/housing/family-housing/). Commuters and Non-Traditional Students can find information on renting [here](https://umaine.edu/cntsp/renterstips/).