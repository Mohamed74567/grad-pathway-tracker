...
| Missing fee field | 20 | Requires thin-snapshot review or explicit source-safe blank treatment. The University of Memphis–UTHSC Biomedical Engineering Ph.D. now uses the official UTHSC no-application-fee treatment; Brown Sc.M. and M.Eng. remain blank because current master’s sources do not publish a comparable fee. |
