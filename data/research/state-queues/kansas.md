# Kansas — State-by-State Bioengineering Candidate Queue

## Scope

Enumerate Kansas graduate programs in biomedical engineering, bioengineering, neuroengineering, and directly adjacent engineering research disciplines. A profile is publishable only after three-pass reconciliation of official institutional sources. Unknown admissions, funding, fee, test, tuition, ranking, and acceptance facts remain blank rather than inferred.

## Initial candidates for official review

| Institution | Candidate graduate programs | Research status |
| --- | --- | --- |
| The University of Kansas | Bioengineering Ph.D. | Pending inherited-profile source refresh. |
| The University of Kansas | Bioengineering M.S. | Pending inherited-profile source refresh. |
| Kansas State University, Wichita State University, and other Kansas institutions | Biomedical engineering, bioengineering, neuroengineering, or directly adjacent graduate degree, if separately awarded | Pending official eligibility determination. |

## Official findings captured for reconciliation
