# Michigan State Queue

## Scope and operating rule

Michigan is the third state in the systematic directory workflow. The queue begins with University of Michigan, which appears in the uploaded tracker but carries a non-official legacy URL that must never be reused. Each published record must have five source-field categories, three verification passes, working official program/application routes, and credited real campus imagery.

## Current directory baseline

| Institution | Published programs | Legacy status | Current provenance status | Next action |
|---|---:|---|---|---|
| University of Michigan | Ph.D. and M.S. Biomedical Engineering | Legacy-listed Ph.D.; legacy link is a non-university chat URL | Three-pass verified | Completed current admissions/funding refresh; public records use direct Rackham ApplyWeb rather than the legacy URL |
