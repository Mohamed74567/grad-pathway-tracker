...
The August 13, 2026 validation query found **23 published New York profiles**. **12** initially met the required five-source-category, three-pass, credited-image standard. Columbia’s Ph.D. and M.S. have now been refreshed to the standard, increasing the validated subset to **14**. The current state queue remains **not yet complete**: inherited records requiring refresh are Cornell (Ph.D.), New York University (Ph.D./M.S.), Stony Brook (Ph.D./M.S.), University at Buffalo (Ph.D./M.S.), and University of Rochester (Ph.D./M.S.). The recent Binghamton, RPI, RIT, Syracuse, CCNY, New York Tech, Cornell M.Eng., and Columbia records meet the standard.
